...
return [
  'up' => "CREATE TABLE `AdminAjaxError` (
  ...
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='後台錯誤紀錄';",

  'down' => "DROP TABLE IF EXISTS `AdminAjaxError`;",

  'at' => "2019-06-24 23:01:56"
];
