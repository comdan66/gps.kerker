...
class AdminAjaxError extends AdminController {
  ...
  public function __construct() {
    ...
    $this->view->with('title', '後台錯誤紀錄')
               ->with('currentMenuUrl', Url::router('AdminAdminAjaxErrorIndex'));
  }
  ...
  public function show() {
    $show = Show::create($this->obj)
                ->setBackRouter('AdminAdminAjaxErrorIndex');
  ...
  public function read() {
    ...
    $params = Input::ValidPost(function($params) {
      Validator::must($params, 'isRead', '已讀')->inEnum(array_keys(\M\AdminAjaxError::IS_READ));
      return $params;
    });
