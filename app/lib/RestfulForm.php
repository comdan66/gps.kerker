...
abstract class Input extends Row {
  protected $name, $value, $autofocus, $placeholder, $type, $min, $max, $disable;
  ...
  public function setValue ($value) { (is_string ($value) || is_numeric ($value) || is_callable($value) ) && $this->value = $value; return $this; }
  ...
  public function setDisable() { $this->disable = 'disabled'; return $this; }
  ...
  public function toString () {
    ...
    is_callable($value) && $value = $value($this->obj);
    ...
    $this->disable     && array_push ($attrs, $this->disable);
...
abstract class TextArea extends Row {
  protected $name, $value, $type, $autofocus, $placeholder, $disable;
