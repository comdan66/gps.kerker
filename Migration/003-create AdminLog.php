...
return [
  'up' => "CREATE TABLE `AdminLog` (
    `id`        int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    
    `adminId`   int(11) unsigned NOT NULL COMMENT 'Admin ID',
    `method`    enum('get', 'post', 'put', 'delete', 'other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'other' COMMENT 'Router::requestMethod()',
    `url`       text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Router::current()',
    `get`       text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'json_encode(\$_GET)',
    `post`      text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'json_encode(\$_POST)',
    `file`      text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'json_encode(\$_FILE)',
    `flash`     text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'json_encode(Session Flash Data)',

    `updateAt`  datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新時間',
    `createAt`  datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增時間',
    PRIMARY KEY (`id`),
    KEY `adminId_index` (`adminId`)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='管理員操作記錄';",

  'down' => "DROP TABLE IF EXISTS `AdminLog`;",

  'at' => "2019-06-24 23:01:32"
];
