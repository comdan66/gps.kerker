...
return [
  'up' => "ALTER TABLE `Device` CHANGE `name` `name` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '名稱';",

  'down' => "ALTER TABLE `Device` CHANGE `name` `name` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'Name';",

  'at' => "2019-09-12 10:28:07"
];
