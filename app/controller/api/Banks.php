   ...
   */
    ...
    */
    ...
    public function index() {
      ...
      return Output::json (array_values (array_filter (array_map (function ($bank) {
        return array(
          'id' => $bank->id,
          'name' => $bank->name,
          'code' => $bank->code,
      ...
      }, Bank::find ('all', array ('offset' => $gets['offset'], 'limit' => $gets['limit']))))));
    }
}
